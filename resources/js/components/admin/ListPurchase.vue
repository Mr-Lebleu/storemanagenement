                                        ...
                                        <div class=" table-responsive" id="printableTable">
                                            ...
                                            <div id="purchase_filter" class="dataTables_filter">
                                                ...
                                                <ul class="pagination pagination-sm m-0 float-right">
                                                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><a class="page-link" href="#" @click="fetchPurchases(pagination.prev_page_url)">Précédent</a></li>

                                                    <li class="disabled"><a class="page-link text-dark" href="#">Page {{ pagination.current_page }} of {{ pagination.last_page }}</a></li>

                                                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><a class="page-link" href="#" @click="fetchPurchases(pagination.next_page_url)">Suivant</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
