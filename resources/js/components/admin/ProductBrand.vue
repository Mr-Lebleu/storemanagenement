                                    ...
                                    <div>
                                        <div class=" table-responsive" id="printableTable">
                                            ...
                                            <div id="productbrandTable_wrapper" class="dataTables_wrapper no-footer">
                                                ...
                                                <div class="dataTables_length" id="productbrandTable_length"><label>Afficher
                                                ...
                                                <ul class="pagination pagination-sm m-0 float-right">
                                                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><button class="page-link" href="#" @click="fetchbrands(pagination.prev_page_url)">Précédent</button></li>

                                                    <li class="disabled"><button class="page-link text-dark" href="#">Page {{ pagination.current_page }} of {{ pagination.last_page }}</button></li>

                                                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><button class="page-link" href="#" @click="fetchbrands(pagination.next_page_url)">Suivant</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
