                ...
                <div class="info-box first">
                    <div class="panel">
                        ...
                        <div class="block">
                            ...
                            <p>Pour commande supérieure à 99,99 €</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3 pl-xl-0">
                <div class="info-box">
                    <div class="panel">
                        ...
                        <div class="block">
                            <h4 class="title">Remboursement</h4>
                            <p>30 jours de retour d'argent</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3 pl-xl-0">
              <div class="info-box">
                  <div class="panel">
                      ...
                      <div class="block">
                          <h4 class="title">Paiement enligne protégé</h4>
                          <p>(+1 1234567890)</p>
                      </div>
                  </div>
              </div>
